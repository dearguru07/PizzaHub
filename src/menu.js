  ...
  return (
    <div className="parent">
      ...
      <div className="relative">
        <img
          className="item-img" src={MenuUrl + props.data.card.info.imageId}></img>
...
const Menu = () => {
  const url =
    "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=13.217176&lng=79.1003289&restaurantId=";
  const { id } = useParams();
